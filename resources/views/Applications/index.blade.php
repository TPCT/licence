                                    ...
                                    <div class="d-flex flex-column col align-items-center justify-content-center">
                                        @if($user->active)
                                            <div class="d-flex justify-content-center align-items-center flex-column">
                                                ...
                                                <span class="alert text-center alert-success p-1 mt-1">Remaining: {{\Carbon\Carbon::parse($application->pivot->end_date)->diffInDays(\Carbon\Carbon::today(), true)}} Days</span>
                                            </div>
                                        @else
